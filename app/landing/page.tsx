      ...
      <div className="max-w-6xl mx-auto pt-8 mb-4 flex justify-end gap-3">
        {isInstallable && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all shadow-md text-white"
            style={{
              background: 'linear-gradient(135deg, #FF6B6B 0%, #4ECDC4 100%)'
            }}
            title="Install Party Space as an app"
          >
            <Image src="/download.gif" alt="Install" width={24} height={24} unoptimized />
            Install App
          </button>
        )}
        <button
