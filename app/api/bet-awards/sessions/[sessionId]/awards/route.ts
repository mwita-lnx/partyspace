...
/**
 * BET Awards API - Awards Management
 * Get and create awards for a BET Awards session
 */
export async function GET(
  ...
  try {
    ...
    console.error('Error fetching BET Awards:', error);
    return NextResponse.json(
...
export async function POST(
  ...
  try {
    ...
    console.error('Error creating BET Award:', error);
    return NextResponse.json(
